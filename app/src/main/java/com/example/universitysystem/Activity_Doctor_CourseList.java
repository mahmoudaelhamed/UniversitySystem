...
public class Activity_Doctor_CourseList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__doctor__course_list);
        ...
        Adapter_Student_CourseList mAdapter = new Adapter_Student_CourseList(Activity_Doctor_CourseList.this,0,dataList);
        subjectListView.setAdapter(mAdapter);
        subjectListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Activity_Doctor_CourseList.this, Activity_Doctor_Selected_Course.class);
